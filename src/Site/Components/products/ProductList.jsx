...
const ProductList = ({
  ...
  return (
    <div className="flex flex-col gap-y-3 lg:gap-y-0 lg:flex-row gap-x-12 xl:g-x-0">
      {filter === true ? (
        <div className="lg:w-1/4 w-full shadow-md shadow-gray-300 h-fit">
          <Filter
            filters={filters}
      ...
      <div
        ...
        ${filter === true ? "lg:w-3/4 w-full md:grid-cols-2 2xl:grid-cols-3" : "lg:grid-cols-4"}`}
      >
